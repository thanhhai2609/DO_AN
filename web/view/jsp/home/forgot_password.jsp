                                    ...
                                    <form action="ForgotPasswordServlet" method="get">
                                        <p> 
                                            <c:if test="${requestScope.STATUS == 'forgot'}">
                                                <label>Nhập email của bạn để nhận mã </label><br/>
                                        ...
                                        <c:if test="${requestScope.STATUS != 'success'}">
                                            <div class="login_submit">
                                                <button name="btnAction" value="Enter" type="submit">Gửi</button>
                                            </div>
                                        </c:if>
                                        <c:if test="${requestScope.STATUS == 'success'}">
                                            <div class="user-actions mb-20">
                                                <h3> 
                                                    <a class="Returning" href="login.jsp">Bấm vào đây để đăng nhập</a>     
                                                </h3>
                                            </div>
                                        </c:if>
                                    </form>

                            ...
                            <div class="col-lg-3 col-md-8 col-12">
                                ...
                                <c:if test="${sessionScope.WISHLIST != null}">
                                    ...
                                    <div class="sidebar_widget wishlist mb-35" id="wishlist-small">
                                        <div class="block_title">
                                            <h3><a href="WishlistServlet">Yêu thích</a></h3>
                                        </div>
                                ...
                                <c:if test="${sessionScope.account == null}">
                                    ...
                                    <div class="sidebar_widget newsletter mb-35" id="newsletter-div">
                                        ...
                                        <input id="email-input-at-home" placeholder="Địa chỉ email của bạn" type="text" value="<c:if test="${requestScope.EMAIL_CUSTOMER != null}">${requestScope.EMAIL_CUSTOMER}</c:if>">
                                            <button  onclick="subscribeEmailAtHome('subscribe')">Đăng ký</button>
                                        ...
                                        <div class="single_slider" style="background-image: url(view/assets/home/img/slider/slide_1.png)">
                                            <div class="slider_content">
                                                <div class="slider_content_inner">  
                                                    ...
                                                    <a href="ShopServlet">Mua sắm ngay</a>
                                                </div>     
                                            </div>    
                                        </div>
                                                        ...
                                                        <div class="single_product">
                                                            <div class="product_thumb">
                                                                ...
                                                                <c:if test="${p.discount != 0}">
                                                                    <span class="discount">Giảm tới ${p.discount * 100}%</span>
                                                                </c:if>

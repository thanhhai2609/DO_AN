                                    ...
                                    <div class="table_desc wishlist" style="max-height: 600px; overflow-y: auto;">
                                        <div class="cart_page table-responsive">
                                            ...
                                            <c:if test="${sessionScope.WISHLIST != null && sessionScope.WISHLIST.size() != 0}">
                                                <table>
                                                    <thead>
                                                        <tr><th class="product_thumb" style="min-width: 165px;">Ảnh</th>
                                                            <th class="product_name" style="min-width: 280px;">Sản phầm</th>
                                                            <th class="product-price">Giá</th>
                                                            <th class="product_quantity"style="min-width: 150px;">Tình trạng</th>
                                                        ...
                                                        <c:forEach items="${sessionScope.WISHLIST}" var="p">
                                                            <tr>
                                                                ...
                                                                <c:if test="${p.status == true}">
                                                                    ...
                                                                    <td class="product_total">
                                                                        <button style="color: #00bba6;
                                                                                ...
                                                                                font-size: 13px;
                                                                                padding: 2px 11px;
                                                                                font-weight: 600;" onclick="addProductToCart('Add',${p.id}, 1)"><i class="fa-solid fa-plus"></i>
                                                                        </button>
                                                                    </td>
                                                                </c:if>
                                                                <c:if test="${p.status == false}">
                                                                    ...
                                                                    <td class="product_total"><a href="WishlistServlet?action=Delete&product_id=${p.id}">Xoá</a></td>
                                                                </c:if>
                                                                <td class="product_remove"><a href="WishlistServlet?action=Delete&product_id=${p.id}"><i class="fa-solid fa-delete-left"></i></a></td>
                                                            </tr>
                                                        </c:forEach>
                                                    </tbody>
                                                </table>   

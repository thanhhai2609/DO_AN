                            ...
                            <div class="col-lg-6 col-md-6">
                                <div class="account_form">
                                    ...
                                    <form id="login-form" action="LoginServlet" method="post">
                                        <p> 
                                            <label>Tên người dùng hoặc email</label><br/>
                                        ...
                                        <div  style="margin-top: 10px" class="login_submit">
                                            <button type="submit" name="btnAction" value="Login">Đăng nhập</button>
                                            <label for="remember">
                                        ...
                                        <div style="margin-top: 20px">
                                            <a class="login-with-google-btn" href="https://accounts.google.com/o/oauth2/auth?scope=email%20profile&redirect_uri=http://localhost:8080/PRJ301_Sp24_ClothesShop/LoginServlet&response_type=code
                                               &client_id=40613383185-c4qs0q74c4g95fg8l8lr34q9765bpaet.apps.googleusercontent.com&approval_prompt=force">Đăng nhập với Google</a>
                                            <a href="ForgotPasswordServlet?status=forgot" style="margin-left: 20px">Quên mật khẩu</a>
                                        </div>
                                    </form>
                                </div>    
                            </div>
                                ...
                                <div class="account_form register">
                                    ...
                                    <form id="register-form" action="RegisterServlet" method="post">
                                        ...
                                        <div class="login_submit">
                                            <button name="btnAction" value="Register" type="submit" onclick="checkForm()">Đăng ký</button>
                                        </div>
                                    </form>
                                </div>    
                            </div>

                            ...
                            <form id="form-filter" action="FilterServlet" method="get" class="col-lg-3 col-md-12">
                                ...
                                <div class="sidebar_widget price">
                                    ...
                                    <div class="shopee-price-range-filter__inputs" style="margin: 1.25rem 2px 0.625rem;
                                         ...
                                         align-items: center;
                                         padding-right: 30px">
                                        <input type="number" style="height: 35px; width: 90px; background-color: white" name="pricefrom" class="shopee-price-range-filter__input" placeholder="từ &#273; " value="${price1}" step="0.5" min=1>
                                        ...
                                        <input type="number" style="height: 35px; width: 90px; background-color: white" name="priceto" class="shopee-price-range-filter__input" placeholder="tới &#273;" value="${price2}" step="0.5" min=1">
                                    </div>
                                </div>                                    
                                <!--price slider end-->
                                ...
                                <button  class="submit-price" style="font-size: 16px;
                                         ...
                                         padding: 5px 20px;
                                         border-radius: 20px;
                                         margin: 10px 0 20px">Đồng ý</button>
                                ...
                                <c:if test="${sessionScope.account !=null || sessionScope.WISHLIST != null}">
                                    ...
                                    <div class="sidebar_widget wishlist mb-35" id="wishlist-small">
                                        ...
                                        <div class="block_content">
                                            ...
                                            <a href="WishlistServlet">» Yêu thích</a>
                                        </div>
                                    </div>
                                    <!--wishlist block end-->
                                </c:if>
                                                        ...
                                                        <div class="single_product">
                                                            <div class="product_thumb">
                                                                ...
                                                                <c:if test="${p.discount != 0}">
                                                                    <span class="discount">Giảm giá ${p.discount * 100}%</span>
                                                                </c:if>

                                    ...
                                    <div class="cart_page table-responsive">
                                        ...
                                        <c:if test="${sessionScope.CART != null && sessionScope.CART.size() != 0}">
                                            <table>
                                                <thead>
                                                    <tr>
                                                        <th class="product_thumb" style="min-width: 165px;">Ảnh</th>
                                                        <th class="product_name" style="min-width: 280px;">Sản phẩm</th>
                                                        <th class="product-price">Giá</th>
                                                        <th class="product_quantity"style="min-width: 150px;">Số lượng</th>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td class="product_remove">
                                                                <button style="color: #00bba6;
                                                                        ...
                                                                        padding: 2px 11px;
                                                                        margin-right: 10px;
                                                                        font-weight: 600;" onclick="updateProductCart('Update',${c.product.id},${c.product.stock})">Cập nhật</button>
                                                                ...
                                                                <button style="color: #00bba6;
                                                                        ...
                                                                        border-radius: 4px;
                                                                        padding: 2px 11px;
                                                                        font-weight: 600;" onclick="deleteProductFromCartPage('Delete',${c.product.id}, 'cart.jsp')">Xoá</button>
                                                            </td>
                                                        </tr>
                                                    </c:forEach>
                                                </tbody>

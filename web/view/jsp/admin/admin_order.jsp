                    ...
                    <div class="tile">
                        <div class="tile-body">
                            ...
                            <table class="table table-hover table-bordered" id="sampleTable">
                                ...
                                <tbody>
                                    <c:forEach items="${LIST_ORDERS}" var="o">
                                        <tr>
                                            <td>${o.orderID}</td>
                                            ...
                                            <td>${o.orderDate}</td>
                                            <td>${o.totalPrice}</td>
                                            <td><span class="badge bg-success">${o.paymentMethod.paymentMethod}</span></td>
                                            <td>
                                                ${o.status?"Đã giao":"Chưa giao..."}
                                                <c:if test="${!o.status}">
                                                    <button style="margin-left: 20px; float: right; cursor: pointer" onclick="changeStatus(this, ${o.orderID})">

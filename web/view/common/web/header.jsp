...
<div class="header_area" style="font-family: arial">
    <!--header top--> 
...
<!--                                <div class="switcher">
            ...
            <div class="col-lg-6 col-md-6">
                <div class="header_links">
                    <ul>
                        <li><a href="ContactServlet" title="Contact">Liên hệ</a></li>
                        <li><a href="WishlistServlet" title="wishlist">Yêu thích</a></li>
                        <li><a href="CartServlet" title="My cart">Giỏ hàng</a></li>  
                            <c:if test="${sessionScope.account != null}">
                            <li><a href="ProfileServlet" title="My account">Tài khoản</a></li>
                            </c:if>
                            <c:if test="${sessionScope.account == null}">
                            <li><a href="DispatchServlet?btnAction=Login" title="Login">Đăng nhập</a></li>  
                            </c:if>
                            <c:if test="${sessionScope.account != null}">
                            <li><a href="${sessionScope.account.roleID == 1 ? 'AdminServlet' : 'ProfileServlet'} ">Xin chào, ${sessionScope.account.firstName} ${sessionScope.account.lastName}!</a></li>
                            <li><a href="DispatchServlet?btnAction=Logout">Đăng xuất</a></li>
                            </c:if>
                    </ul>
                </div>   
            </div>
    ...
    <div class="header_middel">
        <div class="row align-items-center">
            ...
            <div class="col-lg-3 col-md-3">
                <div class="logo">
                    <a href="DispatchServlet"><img src="view/assets/home/img/logo/logo.png" alt="" style="width: 100px; height: auto;"></a>
                </div>
            </div>
            <!--logo end-->
            ...
            <div class="col-12">
                <div class="main_menu_inner">
                    <div class="main_menu d-none d-lg-block">
                        <nav>
                            <ul>
                                <li class="${requestScope.CURRENTSERVLET == "Home" ? "active" : ""}"><a href="DispatchServlet">Trang chủ</a></li>
                                <li class="${requestScope.CURRENTSERVLET == "Shop" ? "active" : ""}"><a href="ShopServlet">Mua hàng</a></li>
                                <li class="${requestScope.CURRENTSERVLET == "Contact" ? "active" : ""}"><a href="ContactServlet">Liên hệ</a></li>
                            </ul>
                        </nav>
                    </div>
                </div>

...
public class Email {
    ...
    private final String eFrom = "thanhhaifc2k2@gmail.com";
    private final String ePass = "tlel zros szkf bnkx";
    ...
    public String subjectContact(String name) {
        return "Bảo Nam - Chào " + name + " cảm ơn bạn vì đã liên hệ với chúng tôi";
    }
    
    public String subjectNewOrder() {
        return "Bảo Nam - Đặt hàng thành công";
    }

    public String subjectSubsribe() {
        return "Bảo Nam - bạn có thông báo mới";
    }

    public String subjectForgotPass() {
        return "Bảo Nam - mã code xác nhận";
    }
    ...
    public String messageContact(String name) {
        return "<!DOCTYPE html>\n"
                ...
                + "                                       margin:20px 0;\"><span style=\"color:#e67e22;\">Bảo</span>Nam</p> \n"
                + "                                </td>\n"
                + "                            </tr>\n"
                + "                            <tr>\n"
                ...
                + "                                        color:#e67e22;\n"
                + "                                        margin:30px 0;\">CẢM ƠN VÌ BẠN ĐÃ LIÊN HỆ VỚI BẢO NAM</h1>\n"
                ...
                + "                                <td align=\"center\"> \n"
                + "                                    Bao Nam  - 0123 456 789 - baonam@gmail.com\n"
                + "                                </td>\n"
                + "                            </tr>\n"
                + "                        </table>\n"
                + "                    </div> \n"
    ...
    public String messageSubscribe() {
        return "<!DOCTYPE html>\n"
                ...
                + "                                        color:#e67e22;\n"
                + "                                        text-height:36px;\n"
                + "                                        margin:30px 0;\">CHÀO MỪNG BẠN ĐÃ ĐẾN VỚI BẢO NAM</h1>\n"
    ...
    public static void main(String[] args) {
        ...
        String email = "thanhhaifc2k2@gmail.com";
        String sub = "Subject";

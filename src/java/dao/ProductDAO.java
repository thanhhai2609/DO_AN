...
public class ProductDAO extends DBContext {
    ...
    private static final String GET_PRODUCTS_BEST_SELLER = "SELECT * from Products WHERE status = 1 ORDER BY unitSold DESC LIMIT 5";
    ...
    private static final String INSERT_PRODUCT = "INSERT INTO Products (`productname`, `supplierid`, `categoryid`, `size`, `stock`, `description`, `images`, `colors`, `releasedate`, `discount`, `unitSold`, `price`, `status`, `typeid`) VALUES (?,?,?,?,?,?,?,?,?,?,?,?,?,?)";

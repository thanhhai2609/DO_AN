            ...
            if (request.getParameter("btnAction") != null) {
                ...
                if (userGG != null) {
                    ...
                    if (account != null) {
                        ...
                        String error = "Bạn cần đăng ký tài khoản!";
...
protected void doPost(HttpServletRequest request, HttpServletResponse response)
    ...
    try (PrintWriter out = response.getWriter()) {
        ...
        try {
            ...
            UserDTO user = udao.checkLogin(username, passwordMH); // Kiểm tra với mật khẩu mã hóa

            if (user != null) { // Kiểm tra nếu người dùng tồn tại với mật khẩu mã hóa
                HttpSession session = request.getSession();
            ...
            log("LoginServlet error:" + ex.getMessage());
            response.sendError(HttpServletResponse.SC_INTERNAL_SERVER_ERROR, "Có lỗi xảy ra trong quá trình đăng nhập.");
        }
    }
}
